...
% For saving:::::
sprint.pad_samps = pad_samps;
sprint.signal_padded = signal_padded;
sprint.win_starts = win_starts;
sprint.win_centers = win_centers;
sprint.n_wins = n_wins; 
...
%%%% LOOP THROUGH CHANNELS AND STORE THE MEAN PSD
